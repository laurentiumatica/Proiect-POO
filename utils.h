...
inline void validate_material_id(const std::string &id) {
    if (id.empty()) {
...
inline void validate_material_name(const std::string &name) {
    if (name.empty()) {
...
inline void validate_material_measure_unit(const std::string &measure_unit) {
...
inline void validate_material_quantity(const double quantity) {
    if (quantity < 0) {
        throw ValidationException("Material quantity must not be negative");
    }
}

inline void validate_material_critical(const double critical) {
    if (critical < 0) {
        throw ValidationException("Material critical level must not be negative");
    }
}

inline void validate_material_unit_price(const double unit_price) {
    if (unit_price <= 0) {
...
inline void validate_transaction_id(const std::string &id) {
    if (id.empty()) {
...
inline void validate_transaction_date(const std::string &date) {
    if (date.empty())
...
inline void validate_materials_uniqueness(const std::string &id, const std::vector<Material> &materials) {
...
inline void validate_transaction_materials_number(const int number) {
    if (number < 1) {
...
inline void validate_transaction_materials(const std::vector<Material> &materials) {
...
inline void validate_transaction_uniqueness(const std::string &id, const std::vector<std::unique_ptr<Transaction>> &transactions) {
...
inline void validate_consumption_record_project_name(const std::string &name) {
    if (name.empty())
...
inline void validate_consumption_record_department(const std::string &department) {
    if (department.empty())
...
inline void validate_refund_transaction_reason(const std::string &reason) {
    if (reason.empty())
...
inline void validate_adjustment_transaction_reason(const std::string &reason) {
    if (reason.empty())
...
inline void validate_provider_id(const std::string &id) {
    if (id.empty()) {
...
inline void validate_provider_name(const std::string &name) {
    if (name.empty())
...
inline void validate_provider_phone(const std::string &phone) {
    if (phone.empty()) {
...
inline void validate_provider_email(const std::string &email) {
    if (email.empty()) {
...
inline void validate_provider_address(const std::string &address) {
    if (address.empty()) {
...
inline void validate_provider_materials_number(const int number) {
    if (number < 1)
...
inline void validate_provider_materials(const std::vector<Material> &materials) {
...
inline void validate_inventory_id(const std::string &id) {
    if (id.empty()) {
...
inline void validate_inventory_name(const std::string &name) {
    if (name.empty())
...
inline void validate_inventory_phone(const std::string &phone) {
    if (phone.empty()) {
...
inline void validate_inventory_email(const std::string &email) {
    if (email.empty()) {
...
inline void validate_inventory_address(const std::string &address) {
    if (address.empty()) {
...
inline void validate_inventory_materials_number(const int number) {
    if (number < 0)
...
inline void validate_inventory_materials(const std::vector<Material> &materials) {
...
inline void validate_inventory_providers(const std::vector<Provider> &providers) {
...
// Functii helper pentru citire (template — nu necesita inline)
inline void read_string(const std::string &prompt, auto function) {
    while (true) {
        try {
            std::cout << prompt << ": ";
            std::string temp;
